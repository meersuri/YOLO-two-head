# -*- coding: utf-8 -*-
"""
Created on Mon Dec 16 10:44:47 2019
...
def load_darknet_weights(self, weights, skip_copy = [], cutoff=-1):
    ...
    for i, (mdef, module) in enumerate(zip(self.module_defs[:cutoff], self.module_list[:cutoff])):
        ...
        if i in skip_copy:
            print('skip new branch layer - ', module[0])
            continue
        ...
        if mdef['type'] == 'convolutional':
            ...
            print(conv_w.shape, " ->", conv_layer.weight.shape)
