...
wget -c -k https://pjreddie.com/media/files/train2014.zip
wget -c -k https://pjreddie.com/media/files/val2014.zip
...
wget -c -k https://pjreddie.com/media/files/instances_train-val2014.zip
wget -c -k https://pjreddie.com/media/files/coco/5k.part
wget -c -k https://pjreddie.com/media/files/coco/trainvalno5k.part
wget -c -k https://pjreddie.com/media/files/coco/labels.tgz
tar xzf labels.tgz
unzip -q instances_train-val2014.zip

# Set Up Image Lists
paste <(awk "{print "C:\\Users\\user\\yolov3\\coco\\"}" <5k.part) 5k.part | tr -d '\t' > 5k.txt
paste <(awk "{print "C:\\Users\\user\\yolov3\\coco\\"}" <trainvalno5k.part) trainvalno5k.part | tr -d '\t' > trainvalno5k.txt
